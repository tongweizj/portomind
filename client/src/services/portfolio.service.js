...
// CM-20：默认排除已归档组合，includeArchived=true 时包含
export const getPortfoliosSummary = async ({ includeArchived = false } = {}) =>
  (await api.get('/portfolios/summary', { params: { includeArchived } })).data;
